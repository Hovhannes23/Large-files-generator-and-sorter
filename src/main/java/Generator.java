...
public class Generator {
    ...
    public static File generateFile(int countOfLines, int maxLengthOfLine) {
       ...
       try(Writer out=new BufferedWriter(new FileWriter(generatedFile));) { // create writer which will write text to our generated file
           ...
           for (int i = 0; i < countOfLines; i++) {   // in this loop we randomly choose letters and concat them to String. Count of letters in one line is from 1 to maxLengthOfLine.
               StringBuilder res =
               ...
               out.append(res); // write String to generatedFile
               out.append("\n");
           }
       }
        catch (IOException e){
